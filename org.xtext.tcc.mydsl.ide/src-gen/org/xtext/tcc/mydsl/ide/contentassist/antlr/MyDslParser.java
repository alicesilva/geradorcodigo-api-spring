...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_0(), "rule__AtributoTipo__TipoAssignment_0");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_1(), "rule__AtributoTipo__TipoAssignment_1");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_2(), "rule__AtributoTipo__TipoAssignment_2");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_3(), "rule__AtributoTipo__TipoAssignment_3");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_4(), "rule__AtributoTipo__TipoAssignment_4");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_5(), "rule__AtributoTipo__TipoAssignment_5");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_6(), "rule__AtributoTipo__TipoAssignment_6");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_7(), "rule__AtributoTipo__TipoAssignment_7");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_8(), "rule__AtributoTipo__TipoAssignment_8");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_9(), "rule__AtributoTipo__TipoAssignment_9");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_10(), "rule__AtributoTipo__TipoAssignment_10");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_11(), "rule__AtributoTipo__TipoAssignment_11");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_12(), "rule__AtributoTipo__TipoAssignment_12");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_13(), "rule__AtributoTipo__TipoAssignment_13");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoAssignment_14(), "rule__AtributoTipo__TipoAssignment_14");
