...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_VAZIO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1781:12: ( '\"\"' )
            // InternalMyDsl.g:1781:14: '\"\"'
            {
            match("\"\""); 
    ...
    public final void mRULE_NOME_ASSOCIACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1783:22: ( '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' ) '\"' )
            // InternalMyDsl.g:1783:24: '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:1783:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )
            int alt1=5;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // InternalMyDsl.g:1783:29: 'OneToOne'
                    {
                    match("OneToOne"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:1783:40: 'OneToMany'
                    {
                    match("OneToMany"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:1783:52: 'ManyToOne'
                    {
                    match("ManyToOne"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:1783:64: 'ManyToMany'
                    {
                    match("ManyToMany"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:1783:77: 'None-Associacao'
                    {
    ...
    public final void mRULE_NOME_OPERACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1785:20: ( '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"' )
            // InternalMyDsl.g:1785:22: '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:1785:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )
            int alt2=7;
            alt2 = dfa2.predict(input);
            switch (alt2) {
                case 1 :
                    // InternalMyDsl.g:1785:27: 'ALL'
                    {
                    match("ALL"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:1785:33: 'DETACH'
                    {
                    match("DETACH"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:1785:50: 'PERSIST'
                    {
                    match("PERSIST"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:1785:60: 'REFRESH'
                    {
                    match("REFRESH"); 
                    ...
                    break;
                case 6 :
                    // InternalMyDsl.g:1785:70: 'REMOVE'
                    {
                    match("REMOVE"); 
                    ...
                    break;
                case 7 :
                    // InternalMyDsl.g:1785:79: 'None-Operacao'
                    {
                    match("None-Operacao"); 
    ...
    public final void mRULE_TIPO_DEFINIDO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1787:20: ( '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' ) '\"' )
            // InternalMyDsl.g:1787:22: '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:1787:26: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' )
            int alt3=12;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalMyDsl.g:1787:27: 'Boolean'
                    {
                    match("Boolean"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:1787:37: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:1787:54: 'String'
                    {
                    match("String"); 
                ...
                case 5 :
                    ...
                    break;
                case 6 :
                    // InternalMyDsl.g:1787:71: 'Double'
                    {
                    match("Double"); 
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // InternalMyDsl.g:1787:87: 'Timestamp'
                    {
                    match("Timestamp"); 
                ...
                case 10 :
                    ...
                    break;
                case 11 :
                    // InternalMyDsl.g:1787:113: 'ArrayList'
                    {
                    match("ArrayList"); 
                    ...
                    break;
                case 12 :
                    // InternalMyDsl.g:1787:125: 'HashSet'
                    {
                    match("HashSet"); 
    ...
    public final void mRULE_STRING_LIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1789:17: ( '\"' ( RULE_LETRA )+ '\"' )
            // InternalMyDsl.g:1789:19: '\"' ( RULE_LETRA )+ '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:1789:23: ( RULE_LETRA )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_LETRA() throws RecognitionException {
        try {
            // InternalMyDsl.g:1791:21: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
            // InternalMyDsl.g:1791:23: ( 'a' .. 'z' | 'A' .. 'Z' )
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1793:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:1793:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyDsl.g:1793:11: ( '^' )?
            int alt5=2;
            ...
            // InternalMyDsl.g:1793:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1795:10: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:1795:12: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:1795:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1797:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:1797:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:1797:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalMyDsl.g:1797:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:1797:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:1797:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:1797:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1799:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:1799:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:1799:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1801:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyDsl.g:1801:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyDsl.g:1801:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1803:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:1803:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:1803:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:1805:16: ( . )
            // InternalMyDsl.g:1805:18: .
            {
            matchAny(); 
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "1783:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )";
        }
    }
    ...
    class DFA2 extends DFA {
        ...
        public String getDescription() {
            return "1785:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )";
        }
    }
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "1787:26: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' )";
        }
    }
