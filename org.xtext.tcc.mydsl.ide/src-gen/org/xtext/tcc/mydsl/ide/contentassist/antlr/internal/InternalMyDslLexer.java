...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_NOME_ASSOCIACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2331:22: ( '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )? '\"' )
            // InternalMyDsl.g:2331:24: '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )? '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:2331:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )?
            int alt1=6;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // InternalMyDsl.g:2331:29: 'OneToOne'
                    {
                    match("OneToOne"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:2331:40: 'OneToMany'
                    {
                    match("OneToMany"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:2331:52: 'ManyToOne'
                    {
                    match("ManyToOne"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:2331:64: 'ManyToMany'
                    {
                    match("ManyToMany"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:2331:77: 'None-Associacao'
                    {
    ...
    public final void mRULE_NOME_OPERACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2333:20: ( '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"' )
            // InternalMyDsl.g:2333:22: '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:2333:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )
            int alt2=7;
            alt2 = dfa2.predict(input);
            switch (alt2) {
                case 1 :
                    // InternalMyDsl.g:2333:27: 'ALL'
                    {
                    match("ALL"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:2333:33: 'DETACH'
                    {
                    match("DETACH"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:2333:50: 'PERSIST'
                    {
                    match("PERSIST"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:2333:60: 'REFRESH'
                    {
                    match("REFRESH"); 
                    ...
                    break;
                case 6 :
                    // InternalMyDsl.g:2333:70: 'REMOVE'
                    {
                    match("REMOVE"); 
                    ...
                    break;
                case 7 :
                    // InternalMyDsl.g:2333:79: 'None-Operacao'
                    {
                    match("None-Operacao"); 
    ...
    public final void mRULE_TIPO_PRIMITIVO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2335:21: ( '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' ) '\"' )
            // InternalMyDsl.g:2335:23: '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:2335:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' )
            int alt3=10;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalMyDsl.g:2335:28: 'Boolean'
                    {
                    match("Boolean"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:2335:38: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:2335:55: 'String'
                    {
                    match("String"); 
                ...
                case 5 :
                    ...
                    break;
                case 6 :
                    // InternalMyDsl.g:2335:72: 'Double'
                    {
                    match("Double"); 
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // InternalMyDsl.g:2335:88: 'Timestamp'
                    {
                    match("Timestamp"); 
    ...
    public final void mRULE_TIPO_COLECAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2337:19: ( '\"' ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' ) '\"' )
            // InternalMyDsl.g:2337:21: '\"' ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:2337:25: ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' )
            int alt4=4;
            switch ( input.LA(1) ) {
            case 'L':
                {
            ...
            switch (alt4) {
                case 1 :
                    // InternalMyDsl.g:2337:26: 'List<' RULE_STRING_I '>'
                    {
                    match("List<"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:2337:52: 'Set<' RULE_STRING_I '>'
                    {
                    match("Set<"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:2337:77: 'ArrayList<' RULE_STRING_I '>'
                    {
                    match("ArrayList<"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:2337:108: 'HashSet<' RULE_STRING_I '>'
                    {
                    match("HashSet<"); 
    ...
    public final void mRULE_STRING_LIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2339:17: ( '\"' ( RULE_LETRA )+ '\"' )
            // InternalMyDsl.g:2339:19: '\"' ( RULE_LETRA )+ '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:2339:23: ( RULE_LETRA )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_STRING_I() throws RecognitionException {
        try {
            // InternalMyDsl.g:2341:24: ( ( RULE_LETRA )+ )
            // InternalMyDsl.g:2341:26: ( RULE_LETRA )+
            {
            // InternalMyDsl.g:2341:26: ( RULE_LETRA )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_LETRA() throws RecognitionException {
        try {
            // InternalMyDsl.g:2343:21: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
            // InternalMyDsl.g:2343:23: ( 'a' .. 'z' | 'A' .. 'Z' )
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2345:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:2345:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyDsl.g:2345:11: ( '^' )?
            int alt7=2;
            ...
            // InternalMyDsl.g:2345:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2347:10: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:2347:12: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:2347:12: ( '0' .. '9' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2349:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:2349:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:2349:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalMyDsl.g:2349:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:2349:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:2349:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:2349:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2351:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:2351:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:2351:24: ( options {greedy=false; } : . )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2353:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyDsl.g:2353:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyDsl.g:2353:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2355:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:2355:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:2355:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt17=0;
            loop17:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2357:16: ( . )
            // InternalMyDsl.g:2357:18: .
            {
            matchAny(); 
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "2331:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )?";
        }
    }
    ...
    class DFA2 extends DFA {
        ...
        public String getDescription() {
            return "2333:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )";
        }
    }
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "2335:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' )";
        }
    }
