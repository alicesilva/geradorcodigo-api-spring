...
public class ApiImpl extends MinimalEObjectImpl.Container implements Api
{
  ...
  /**
   * The cached value of the '{@link #getEntidades() <em>Entidades</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEntidades()
   * @generated
   ...
   * @generated
   */
  public NotificationChain basicSetEntidades(Entidades newEntidades, NotificationChain msgs)
  {
    Entidades oldEntidades = entidades;
    entidades = newEntidades;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.API__ENTIDADES, oldEntidades, newEntidades);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   */
  @Override
  public void setEntidades(Entidades newEntidades)
  {
    if (newEntidades != entidades)
    {
      NotificationChain msgs = null;
      if (entidades != null)
        msgs = ((InternalEObject)entidades).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.API__ENTIDADES, null, msgs);
      if (newEntidades != null)
        msgs = ((InternalEObject)newEntidades).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.API__ENTIDADES, null, msgs);
      msgs = basicSetEntidades(newEntidades, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.API__ENTIDADES, newEntidades, newEntidades));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.API__ENTIDADES:
        return basicSetEntidades(null, msgs);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MyDslPackage.API__NOME_API:
        ...
        return;
      case MyDslPackage.API__ENTIDADES:
        setEntidades((Entidades)newValue);
        return;
    }
