...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_NOME_OPERACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:915:20: ( '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' ) '\"' )
            // InternalMyDsl.g:915:22: '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:915:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' )
            int alt2=6;
            switch ( input.LA(1) ) {
            case 'A':
                {
    ...
    public final void mRULE_TIPO_PRIMITIVO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:917:21: ( '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' ) '\"' )
            // InternalMyDsl.g:917:23: '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:917:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' )
            int alt3=9;
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "917:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' )";
        }
    }
