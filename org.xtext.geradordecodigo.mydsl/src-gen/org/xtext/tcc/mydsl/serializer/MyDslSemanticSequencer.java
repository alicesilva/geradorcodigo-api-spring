...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (nomeEntidade=Nome atributos=Atributos package=Nome)
	 */
	protected void sequence_Entidade(ISerializationContext context, Entidade semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.ENTIDADE__PACKAGE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.ENTIDADE__PACKAGE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		...
		feeder.accept(grammarAccess.getEntidadeAccess().getPackageNomeParserRuleCall_13_0(), semanticObject.getPackage());
		feeder.finish();
	}
