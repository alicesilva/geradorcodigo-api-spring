  ...
  public CharSequence compileAssociacao(final Atributo atributo, final String nomeEntidade) {
    StringConcatenation _builder = new StringConcatenation();
    {
      if ((atributo.getAssociacao().getAssociacao().equals("OneToOne") || atributo.getAssociacao().getAssociacao().equals("ManyToOne"))) {
        ...
        _builder.append(_tipoObjeto);
        _builder.append("/{");
        String _firstLower_1 = StringExtensions.toFirstLower(nomeEntidade);
        _builder.append(_firstLower_1);
        _builder.append("Id}/{");
        String _firstLower_2 = StringExtensions.toFirstLower(atributo.getAtributoTipo().getTipoObjeto());
        _builder.append(_firstLower_2);
        ...
        String _firstLower_3 = StringExtensions.toFirstLower(nomeEntidade);
        _builder.append(_firstLower_3);
        ...
        _builder.append("\t");
        _builder.append("@PathVariable(\"");
        String _firstLower_5 = StringExtensions.toFirstLower(atributo.getAtributoTipo().getTipoObjeto());
        _builder.append(_firstLower_5, "\t");
        _builder.append("Id\") Long ");
        ...
        _builder.append("\t");
        _builder.append("if (!");
        String _firstLower_7 = StringExtensions.toFirstLower(nomeEntidade);
        _builder.append(_firstLower_7, "\t");
        _builder.append("Service.exists");
        ...
        _builder.append("\t");
        _builder.append("if (!");
        String _firstLower_9 = StringExtensions.toFirstLower(atributo.getAtributoTipo().getTipoObjeto());
        _builder.append(_firstLower_9, "\t");
        _builder.append("Service.exists");
        ...
        _builder.append("\t");
        _builder.append("this.");
        String _firstLower_14 = StringExtensions.toFirstLower(nomeEntidade);
        _builder.append(_firstLower_14, "\t");
        _builder.append("Service.update(");
        String _firstLower_15 = StringExtensions.toFirstLower(nomeEntidade);
        _builder.append(_firstLower_15, "\t");
        _builder.append("Id, ");
        String _firstLower_16 = StringExtensions.toFirstLower(atributo.getAtributoTipo().getTipoObjeto());
        _builder.append(_firstLower_16, "\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t\t\t\t");
        _builder.newLine();
        _builder.append("\t");
        _builder.append("return new ResponseEntity(\"Ok.\", HttpStatus.OK);");
        _builder.newLine();
        _builder.append("}");
        _builder.newLine();
      } else {
        if ((atributo.getAssociacao().getAssociacao().equals("OneToMany") || atributo.getAssociacao().getAssociacao().equals("ManyToMany"))) {
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("@PutMapping(value = \"/");
          String _firstLower_17 = StringExtensions.toFirstLower(nomeEntidade);
          _builder.append(_firstLower_17);
          _builder.append("s-");
          String _firstLower_18 = StringExtensions.toFirstLower(nome);
          _builder.append(_firstLower_18);
          ...
          _builder.append(_firstUpper_7);
          _builder.append("(@PathVariable(\"");
          String _firstLower_20 = StringExtensions.toFirstLower(nomeEntidade);
          _builder.append(_firstLower_20);
          _builder.append("Id\") Long ");
          ...
          _builder.append("\t");
          _builder.append("@PathVariable(\"");
          String _firstLower_22 = StringExtensions.toFirstLower(nome);
          _builder.append(_firstLower_22, "\t");
          _builder.append("Id\") Long ");
          ...
          _builder.append("\t");
          _builder.append("if (!");
          String _firstLower_24 = StringExtensions.toFirstLower(nomeEntidade);
          _builder.append(_firstLower_24, "\t");
          _builder.append("Service.exists");
          ...
          _builder.append("\t");
          _builder.append("if (!");
          String _firstLower_26 = StringExtensions.toFirstLower(nome);
          _builder.append(_firstLower_26, "\t");
          _builder.append("Service.exists");
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          String _firstLower_31 = StringExtensions.toFirstLower(nomeEntidade);
          ...
          _builder.append("Id, ");
          String _firstLower_33 = StringExtensions.toFirstLower(nome);
