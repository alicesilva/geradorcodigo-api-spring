...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public CharSequence compileController(final Api api) {
    ...
    _builder.append(_firstUpper, "\t");
    _builder.append("Service ");
    String _firstUpper_1 = StringExtensions.toFirstUpper(api.getEntidades().getEntidade().getNomeEntidade().getNome());
    _builder.append(_firstUpper_1, "\t");
    _builder.append("Service;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
  ...
  public CharSequence compileMetodosController(final Entidade entidade) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("public ResponseEntity<Pessoa> save");
    String _firstUpper = StringExtensions.toFirstUpper(entidade.getNomeEntidade().getNome());
    _builder.append(_firstUpper);
  ...
  public CharSequence compileAssociacao(final Atributo atributo, final String nomeEntidade) {
    StringConcatenation _builder = new StringConcatenation();
    {
      if ((atributo.getAssociacao().getAssociacao().equals("OneToOne") || atributo.getAssociacao().getAssociacao().equals("ManyToOne"))) {
        ...
        _builder.append("\t");
        _builder.append("if (!");
        String _tipoObjeto_4 = atributo.getAtributoTipo().getTipoObjeto();
        _builder.append(_tipoObjeto_4, "\t");
        _builder.append("Service.exists");
        String _firstUpper_3 = StringExtensions.toFirstUpper(atributo.getAtributoTipo().getTipoObjeto());
        _builder.append(_firstUpper_3, "\t");
        _builder.append("ById(");
        String _tipoObjeto_5 = atributo.getAtributoTipo().getTipoObjeto();
        _builder.append(_tipoObjeto_5, "\t");
        _builder.append("Id)) {");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        _builder.append("return new ResponseEntity<>(HttpStatus.NOT_FOUND);");
        ...
        _builder.append(_firstUpper_4, "\t");
        _builder.append(" ");
        String _tipoObjeto_6 = atributo.getAtributoTipo().getTipoObjeto();
        _builder.append(_tipoObjeto_6, "\t");
        _builder.append(" = ");
        String _tipoObjeto_7 = atributo.getAtributoTipo().getTipoObjeto();
        _builder.append(_tipoObjeto_7, "\t");
        _builder.append("Service.get");
        String _firstUpper_5 = StringExtensions.toFirstUpper(atributo.getAtributoTipo().getTipoObjeto());
        _builder.append(_firstUpper_5, "\t");
        _builder.append("ById(");
        String _tipoObjeto_8 = atributo.getAtributoTipo().getTipoObjeto();
        _builder.append(_tipoObjeto_8, "\t");
        _builder.append("Id);");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("this.");
        ...
        _builder.append(nomeEntidade, "\t");
        _builder.append("Id, ");
        String _tipoObjeto_9 = atributo.getAtributoTipo().getTipoObjeto();
        _builder.append(_tipoObjeto_9, "\t");
        _builder.append(");");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t\t\t\t");
        _builder.newLine();
