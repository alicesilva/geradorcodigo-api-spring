...
public interface Api extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Entidades</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Entidades</em>' containment reference.
   * @see #setEntidades(Entidades)
  ...
  /**
   * Sets the value of the '{@link org.xtext.tcc.mydsl.myDsl.Api#getEntidades <em>Entidades</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Entidades</em>' containment reference.
   * @see #getEntidades()
   * @generated
   */
  void setEntidades(Entidades value);
