...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_NOME_ASSOCIACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:734:22: ( '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' ) '\"' )
            // InternalMyDsl.g:734:24: '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:734:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )
            int alt1=5;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // InternalMyDsl.g:734:29: 'OneToOne'
                    {
                    match("OneToOne"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:734:40: 'OneToMany'
                    {
                    match("OneToMany"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:734:52: 'ManyToOne'
                    {
                    match("ManyToOne"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:734:64: 'ManyToMany'
                    {
                    match("ManyToMany"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:734:77: 'None-Associacao'
                    {
    ...
    public final void mRULE_NOME_OPERACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:736:20: ( '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"' )
            // InternalMyDsl.g:736:22: '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:736:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )
            int alt2=7;
            alt2 = dfa2.predict(input);
            switch (alt2) {
                case 1 :
                    // InternalMyDsl.g:736:27: 'ALL'
                    {
                    match("ALL"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:736:50: 'PERSIST'
                    {
                    match("PERSIST"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:736:60: 'REFRESH'
                    {
                    match("REFRESH"); 
                ...
                case 6 :
                    ...
                    break;
                case 7 :
                    // InternalMyDsl.g:736:79: 'None-Operacao'
                    {
                    match("None-Operacao"); 
    ...
    public final void mRULE_TIPO_PRIMITIVO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:738:21: ( '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' ) '\"' )
            // InternalMyDsl.g:738:23: '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:738:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' )
            int alt3=10;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalMyDsl.g:738:28: 'Boolean'
                    {
                    match("Boolean"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:738:38: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // InternalMyDsl.g:738:88: 'Timestamp'
                    {
                    match("Timestamp"); 
    ...
    public final void mRULE_TIPO_COLECAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:740:19: ( '\"' ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' ) '\"' )
            // InternalMyDsl.g:740:21: '\"' ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:740:25: ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' )
            int alt4=4;
            switch ( input.LA(1) ) {
            case 'L':
                {
            ...
            switch (alt4) {
                case 1 :
                    // InternalMyDsl.g:740:26: 'List<' RULE_STRING_I '>'
                    {
                    match("List<"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:740:52: 'Set<' RULE_STRING_I '>'
                    {
                    match("Set<"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:740:77: 'ArrayList<' RULE_STRING_I '>'
                    {
                    match("ArrayList<"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:740:108: 'HashSet<' RULE_STRING_I '>'
                    {
                    match("HashSet<"); 
    ...
    public final void mRULE_STRING_LIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:742:17: ( '\"' ( RULE_LETRA )+ '\"' )
            // InternalMyDsl.g:742:19: '\"' ( RULE_LETRA )+ '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:742:23: ( RULE_LETRA )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_STRING_I() throws RecognitionException {
        try {
            // InternalMyDsl.g:744:24: ( ( RULE_LETRA )+ )
            // InternalMyDsl.g:744:26: ( RULE_LETRA )+
            {
            // InternalMyDsl.g:744:26: ( RULE_LETRA )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_LETRA() throws RecognitionException {
        try {
            // InternalMyDsl.g:746:21: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
            // InternalMyDsl.g:746:23: ( 'a' .. 'z' | 'A' .. 'Z' )
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:748:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:748:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyDsl.g:748:11: ( '^' )?
            int alt7=2;
            ...
            // InternalMyDsl.g:748:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:750:10: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:750:12: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:750:12: ( '0' .. '9' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:752:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:752:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:752:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalMyDsl.g:752:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:752:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:752:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:752:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:754:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:754:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:754:24: ( options {greedy=false; } : . )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:756:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyDsl.g:756:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyDsl.g:756:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:758:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:758:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:758:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt17=0;
            loop17:
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "734:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )";
        }
    }
    ...
    class DFA2 extends DFA {
        ...
        public String getDescription() {
            return "736:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )";
        }
    }
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "738:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' )";
        }
    }
