...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_VAZIO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:734:12: ( '\"\"' )
            // InternalMyDsl.g:734:14: '\"\"'
            {
            match("\"\""); 
    ...
    public final void mRULE_NOME_ASSOCIACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:736:22: ( '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' ) '\"' )
            // InternalMyDsl.g:736:24: '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:736:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )
            int alt1=5;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // InternalMyDsl.g:736:29: 'OneToOne'
                    {
                    match("OneToOne"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:736:40: 'OneToMany'
                    {
                    match("OneToMany"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:736:52: 'ManyToOne'
                    {
                    match("ManyToOne"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:736:64: 'ManyToMany'
                    {
                    match("ManyToMany"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:736:77: 'None-Associacao'
                    {
    ...
    public final void mRULE_NOME_OPERACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:738:20: ( '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"' )
            // InternalMyDsl.g:738:22: '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:738:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )
            int alt2=7;
            alt2 = dfa2.predict(input);
            switch (alt2) {
                case 1 :
                    // InternalMyDsl.g:738:27: 'ALL'
                    {
                    match("ALL"); 
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:738:50: 'PERSIST'
                    {
                    match("PERSIST"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:738:60: 'REFRESH'
                    {
                    match("REFRESH"); 
                ...
                case 6 :
                    ...
                    break;
                case 7 :
                    // InternalMyDsl.g:738:79: 'None-Operacao'
                    {
                    match("None-Operacao"); 
    ...
    public final void mRULE_TIPO_DEFINIDO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:740:20: ( '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' ) '\"' )
            // InternalMyDsl.g:740:22: '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:740:26: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' )
            int alt3=12;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalMyDsl.g:740:27: 'Boolean'
                    {
                    match("Boolean"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:740:37: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // InternalMyDsl.g:740:87: 'Timestamp'
                    {
                    match("Timestamp"); 
                ...
                case 10 :
                    ...
                    break;
                case 11 :
                    // InternalMyDsl.g:740:113: 'ArrayList'
                    {
                    match("ArrayList"); 
                    ...
                    break;
                case 12 :
                    // InternalMyDsl.g:740:125: 'HashSet'
                    {
                    match("HashSet"); 
    ...
    public final void mRULE_LETRA() throws RecognitionException {
        try {
            // InternalMyDsl.g:744:21: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
            // InternalMyDsl.g:744:23: ( 'a' .. 'z' | 'A' .. 'Z' )
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:746:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:746:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyDsl.g:746:11: ( '^' )?
            int alt5=2;
            ...
            // InternalMyDsl.g:746:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:748:10: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:748:12: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:748:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:750:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:750:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:750:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalMyDsl.g:750:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:750:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:750:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:750:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:752:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:752:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:752:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:754:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMyDsl.g:754:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMyDsl.g:754:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:756:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:756:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:756:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:758:16: ( . )
            // InternalMyDsl.g:758:18: .
            {
            matchAny(); 
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "736:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' | 'None-Associacao' )";
        }
    }
    ...
    class DFA2 extends DFA {
        ...
        public String getDescription() {
            return "738:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )";
        }
    }
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "740:26: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' | 'ArrayList' | 'HashSet' )";
        }
    }
