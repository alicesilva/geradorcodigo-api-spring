...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_NOME_ASSOCIACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:917:22: ( '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' )? '\"' )
            // InternalMyDsl.g:917:24: '\"' ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' )? '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:917:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' )?
            int alt1=5;
            alt1 = dfa1.predict(input);
            switch (alt1) {
                case 1 :
                    // InternalMyDsl.g:917:29: 'OneToOne'
                    {
                    match("OneToOne"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:917:40: 'OneToMany'
                    {
                    match("OneToMany"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:917:52: 'ManyToOne'
                    {
                    match("ManyToOne"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:917:64: 'ManyToMany'
                    {
                    match("ManyToMany"); 
    ...
    public final void mRULE_NOME_OPERACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:919:20: ( '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' ) '\"' )
            // InternalMyDsl.g:919:22: '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:919:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' )
            int alt2=6;
            switch ( input.LA(1) ) {
            case 'A':
                {
            ...
            switch (alt2) {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:919:50: 'PERSIST'
                    {
                    match("PERSIST"); 
                    ...
                    break;
                case 5 :
                    // InternalMyDsl.g:919:60: 'REFRESH'
                    {
                    match("REFRESH"); 
    ...
    public final void mRULE_TIPO_PRIMITIVO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:921:21: ( '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' ) '\"' )
            // InternalMyDsl.g:921:23: '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:921:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' )
            int alt3=9;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalMyDsl.g:921:28: 'Boolean'
                    {
                    match("Boolean"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:921:38: 'Integer'
                    {
                    match("Integer"); 
                ...
                case 7 :
                    ...
                    break;
                case 8 :
                    // InternalMyDsl.g:921:88: 'Timestamp'
                    {
                    match("Timestamp"); 
    ...
    public final void mRULE_TIPO_COLECAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:923:19: ( '\"' ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' ) '\"' )
            // InternalMyDsl.g:923:21: '\"' ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:923:25: ( 'List<' RULE_STRING_I '>' | 'Set<' RULE_STRING_I '>' | 'ArrayList<' RULE_STRING_I '>' | 'HashSet<' RULE_STRING_I '>' )
            int alt4=4;
            switch ( input.LA(1) ) {
            case 'L':
                {
            ...
            switch (alt4) {
                case 1 :
                    // InternalMyDsl.g:923:26: 'List<' RULE_STRING_I '>'
                    {
                    match("List<"); 
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:923:52: 'Set<' RULE_STRING_I '>'
                    {
                    match("Set<"); 
                    ...
                    break;
                case 3 :
                    // InternalMyDsl.g:923:77: 'ArrayList<' RULE_STRING_I '>'
                    {
                    match("ArrayList<"); 
                    ...
                    break;
                case 4 :
                    // InternalMyDsl.g:923:108: 'HashSet<' RULE_STRING_I '>'
                    {
                    match("HashSet<"); 
    ...
    public final void mRULE_STRING_LIST_LOW() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:925:22: ( '\"' ( RULE_LETRA_I )+ '\"' )
            // InternalMyDsl.g:925:24: '\"' ( RULE_LETRA_I )+ '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:925:28: ( RULE_LETRA_I )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_LETRA_I() throws RecognitionException {
        try {
            // InternalMyDsl.g:927:23: ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // InternalMyDsl.g:927:25: 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            matchRange('a','z'); 
            // InternalMyDsl.g:927:34: ( 'a' .. 'z' | 'A' .. 'Z' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_STRING_LIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:929:17: ( '\"' RULE_LETRA '\"' )
            // InternalMyDsl.g:929:19: '\"' RULE_LETRA '\"'
            {
            match('\"'); 
            mRULE_LETRA(); 
            match('\"'); 
    ...
    public final void mRULE_STRING_I() throws RecognitionException {
        try {
            // InternalMyDsl.g:931:24: ( RULE_LETRA )
            // InternalMyDsl.g:931:26: RULE_LETRA
            {
            mRULE_LETRA(); 
    ...
    public final void mRULE_LETRA() throws RecognitionException {
        try {
            // InternalMyDsl.g:933:21: ( 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // InternalMyDsl.g:933:23: 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            matchRange('A','Z'); 
            // InternalMyDsl.g:933:32: ( 'a' .. 'z' | 'A' .. 'Z' )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "917:28: ( 'OneToOne' | 'OneToMany' | 'ManyToOne' | 'ManyToMany' )?";
        }
    }
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "921:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' )";
        }
    }
