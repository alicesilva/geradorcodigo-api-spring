...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_NOME_OPERACAO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2332:20: ( '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"' )
            // InternalMyDsl.g:2332:22: '\"' ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:2332:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )
            int alt2=7;
            ...
            switch (alt2) {
                ...
                case 6 :
                    ...
                    break;
                case 7 :
                    // InternalMyDsl.g:2332:79: 'None-Operacao'
                    {
                    match("None-Operacao"); 
    ...
    public final void mRULE_TIPO_PRIMITIVO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:2334:21: ( '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' ) '\"' )
            // InternalMyDsl.g:2334:23: '\"' ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' ) '\"'
            {
            match('\"'); 
            // InternalMyDsl.g:2334:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' )
            int alt3=10;
    ...
    class DFA2 extends DFA {
        ...
        public String getDescription() {
            return "2332:26: ( 'ALL' | 'DETACH' | 'MERGE' | 'PERSIST' | 'REFRESH' | 'REMOVE' | 'None-Operacao' )";
        }
    }
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "2334:27: ( 'Boolean' | 'Integer' | 'Long' | 'String' | 'Float' | 'Double' | 'Time' | 'Timestamp' | 'Date' | 'ENUM' )";
        }
    }
