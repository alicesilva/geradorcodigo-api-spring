...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getEntidadesAccess().getGroup(), "rule__Entidades__Group__0");
			builder.put(grammarAccess.getEntidadesAccess().getGroup_1(), "rule__Entidades__Group_1__0");
			builder.put(grammarAccess.getEntidadeAccess().getGroup(), "rule__Entidade__Group__0");
			builder.put(grammarAccess.getAtributosAccess().getGroup(), "rule__Atributos__Group__0");
			builder.put(grammarAccess.getAtributosAccess().getGroup_1(), "rule__Atributos__Group_1__0");
			builder.put(grammarAccess.getAtributoAccess().getGroup(), "rule__Atributo__Group__0");
			builder.put(grammarAccess.getOperacaoAccess().getGroup(), "rule__Operacao__Group__0");
			builder.put(grammarAccess.getOperacaoAccess().getGroup_1(), "rule__Operacao__Group_1__0");
			...
			builder.put(grammarAccess.getEntidadeAccess().getPackageAssignment_13(), "rule__Entidade__PackageAssignment_13");
			...
			builder.put(grammarAccess.getAtributoAccess().getOperacaoAssignment_16(), "rule__Atributo__OperacaoAssignment_16");
			builder.put(grammarAccess.getOperacaoAccess().getOpCascadaAssignment_0(), "rule__Operacao__OpCascadaAssignment_0");
			builder.put(grammarAccess.getOperacaoAccess().getOpCascadaMaisAssignment_1_1(), "rule__Operacao__OpCascadaMaisAssignment_1_1");
			builder.put(grammarAccess.getOperacaoCascadaAccess().getOperacaoAssignment(), "rule__OperacaoCascada__OperacaoAssignment");
			builder.put(grammarAccess.getAssociacaoAccess().getAssociacaoAssignment(), "rule__Associacao__AssociacaoAssignment");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoPrimitivoAssignment_0(), "rule__AtributoTipo__TipoPrimitivoAssignment_0");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoColecaoAssignment_1(), "rule__AtributoTipo__TipoColecaoAssignment_1");
			builder.put(grammarAccess.getAtributoTipoAccess().getTipoObjetoAssignment_2(), "rule__AtributoTipo__TipoObjetoAssignment_2");
		}
	}
